...
public class GrassDescription : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    public GameObject grassPanel, blackSprite, closeButton, piecesText, ToPage2;


    public void OnPointerEnter(PointerEventData pointerEventData)
    {
        grassPanel.gameObject.SetActive(true);
