...
public class GameOverDraw : MonoBehaviour
{
    public GameObject transition, soundtrack, background, whiteHatAnim, whiteLogoAnim, blackHatAnim, rematchAnim, blackLogoAnim, gameOverTextAnim, winTextAnim, gameOverTextStatic, winTextStatic, staticWhiteLogo, staticWhiteHat, staticBlackLogo, staticBlackHat, restartButton, quitButton;
    public static int num;
    public static Action ResetGameEvent;
    private PhotonView _PhotonView;
    public bool onlineGame = true;
    void Start()
    {
        if (num == 0)
        {
    ...
    public void OnClickedRestartLocal()
    {
        // ResetGameEvent();
   ...
   /* public void OnClickedRestart()
    ...
    public void Show3()
    {
        ...
        staticBlackLogo.gameObject.SetActive(true);
